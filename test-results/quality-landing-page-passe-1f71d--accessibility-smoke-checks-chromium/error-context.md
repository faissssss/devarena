...
Call log:
  ...
  - waiting for getByRole('link', { name: 'Home' })
    8 × locator resolved to <a href="/" aria-current="page" class="rounded-full px-4 py-2 text-sm font-semibold transition bg-stone-900 text-amber-50">Home</a>
...
- generic [ref=e4]:
  - banner [ref=e5]:
    - generic [ref=e6]:
      - link "DA DevArena Competition radar" [active] [ref=e7] [cursor=pointer]:
        - /url: /
        - generic [ref=e8]: DA
        - generic [ref=e9]:
